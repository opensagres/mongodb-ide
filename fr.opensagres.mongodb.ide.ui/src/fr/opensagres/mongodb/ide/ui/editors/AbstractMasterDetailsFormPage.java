...
public abstract class AbstractMasterDetailsFormPage extends AbstractToolbarFormPage {

	private final AbstractMasterDetailsBlock block;
	
	public AbstractMasterDetailsFormPage(FormEditor editor, String id,
			String title) {
		super(editor, id, title);
		block = createMasterDetailsBlock();
	}

	public AbstractMasterDetailsFormPage(String id,
			String title) {
		super(id, title);
		block = createMasterDetailsBlock();
	}
