...
import com.mongodb.tools.shell.IShellCommandListener;
...
public class ShellCommandView extends ViewPart implements IShellCommandListener {
	...
	public void createPartControl(Composite parent) {
		...
		ShellCommandManager.getInstance().addShellListener(this);
	...
	public void dispose() {
		...
		ShellCommandManager.getInstance().removeShellListener(this);
	}
