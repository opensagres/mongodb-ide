...
public class ServerRunnerType implements IServerRunnerType {
	...
	public ServerRunnerType(IServerType serverType, String id,
			String startName, String stopName, String startDescription,
			String stopDescription, IServerRunner runner) {
